...
public class EmergencyController implements Initializable {
    ...
    private void handleRegisterBtn(ActionEvent event) throws ClassNotFoundException, SQLException {
        ...
        if (id.equals("") || p.equals("") || facility.equals("")) {
            AlertMaker.showAlert("Try Again", "Пожалуйста, введите все поля.");
            ...
            try {
                ...
                AlertMaker.showAlert("Sucess", "Пациент успешно зарегистрирован");
                clearCache();
            } catch (Exception ex) {
                AlertMaker.showAlert("Error", "Недействительный идентификатор участника");
            }
        }
    }
