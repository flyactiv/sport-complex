...
public class MaintenanceController implements Initializable {
    ...
    private void loadData() {
        ...
        list1.add(new MaintenanceActivity("Расстановка по своим местам"));
        list1.add(new MaintenanceActivity("Дезинфекция"));
        list2.add(new MaintenanceActivity("Тренажеры и гири"));
        list2.add(new MaintenanceActivity("Коврики убраны на места"));
        list3.add(new MaintenanceActivity("Химия в бассейне"));
    ...
    private void handleRegRepairBtn(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        if (purpose.equals("") || sport.equals("") || amount.equals("")) {
            ...
            try {
                ...
                AlertMaker.showAlert("Success", "Ремонт успешно зарегистрирован");
                clearCache();

            } catch (Exception e) {
                AlertMaker.showAlert("Error", "Сумма может быть только числовой.");
            }
        }
    }
